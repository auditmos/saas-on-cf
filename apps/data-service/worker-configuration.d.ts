/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface BaseEnv --env dev` (hash: 9ca71b0eaaffc1453afb01aef59057e1)
// Runtime types generated with workerd@1.20260114.0 2025-04-01 nodejs_compat
declare namespace Cloudflare {
	...
	interface Env {
		...
		CLOUDFLARE_ENV_STAGING_ADDRESS: string;
		CLOUDFLARE_ENV_PRODUCTION_ADDRESS: string;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "CLOUDFLARE_ENV" | "CLOUDFLARE_ENV_STAGING_ADDRESS" | "CLOUDFLARE_ENV_PRODUCTION_ADDRESS" | "DATABASE_HOST" | "DATABASE_USERNAME" | "DATABASE_PASSWORD" | "API_TOKEN">> {}
}
