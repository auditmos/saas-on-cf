/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env=dev --env-interface=BaseEnv` (hash: 8db0e133fd592d6f650f14c655321dff)
// Runtime types generated with workerd@1.20260730.1 2026-05-25 nodejs_compat
interface __BaseEnv_BaseEnv {
	RATE_LIMITER_MUTATIONS: RateLimit;
	RATE_LIMITER_READS: RateLimit;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "CLOUDFLARE_ENV" | "DATABASE_HOST" | "DATABASE_USERNAME" | "DATABASE_PASSWORD" | "API_TOKEN" | "ALLOWED_ORIGINS">> {}
}
