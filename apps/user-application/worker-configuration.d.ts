/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env=dev --env-interface=BaseEnv` (hash: 64c4c65a65107ef89373c57c5ba51786)
// Runtime types generated with workerd@1.20260730.1 2026-05-25 nodejs_compat
interface __BaseEnv_BaseEnv {
	RATE_LIMITER_SERVER_FN: RateLimit;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "CLOUDFLARE_ENV" | "DATABASE_HOST" | "DATABASE_USERNAME" | "DATABASE_PASSWORD" | "BETTER_AUTH_SECRET" | "BETTER_AUTH_BASE_URL" | "VITE_DATA_SERVICE_URL" | "VITE_API_TOKEN" | "DATA_SERVICE_API_TOKEN">> {}
}
