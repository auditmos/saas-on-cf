...
const operations = [
  ...
  { label: 'Read', href: '/dashboard/binding/read' as const, desc: 'GET /clients/:id via service binding' },
  { label: 'List', href: '/dashboard/binding/list' as const, desc: 'GET /clients via service binding' },
...
data-ops queries → Neon Postgres`}
          ...
          <div className="bg-info/10 p-4 rounded">
            ...
            <p className="text-sm mt-1 text-muted-foreground">Internal microservices, shared business logic, centralized validation</p>
          </div>

          <div className="bg-warning/10 p-4 rounded">
            <h4 className="font-semibold text-foreground">When NOT to Use</h4>
            <p className="text-sm mt-1 text-muted-foreground">Need lowest latency, data-service down = app down</p>
          </div>
