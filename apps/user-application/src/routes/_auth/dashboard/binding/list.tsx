              ...
              <div className="flex items-center justify-between">
                ...
                <div className="flex gap-2">
                  <Button
                    ...
                    onClick={() => navigate({ to: '/dashboard/binding/list', search: { ...pagination, offset: Math.max(0, pagination.offset - pagination.limit) } })}
                  >
                    Previous
                  </Button>
                  <Button
                    ...
                    onClick={() => navigate({ to: '/dashboard/binding/list', search: { ...pagination, offset: pagination.offset + pagination.limit } })}
                  >
                    Next
                  </Button>
                </div>
