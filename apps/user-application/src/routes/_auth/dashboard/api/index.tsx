...
data-ops queries → Neon Postgres`}
          ...
          <div className="bg-info/10 p-4 rounded">
            ...
            <p className="text-sm mt-1 text-muted-foreground">Mobile apps, third-party integrations, public API consumers</p>
          </div>

          <div className="bg-warning/10 p-4 rounded">
            <h4 className="font-semibold text-foreground">When NOT to Use</h4>
            <p className="text-sm mt-1 text-muted-foreground">Need SSR, sensitive operations, internal-only features</p>
          </div>
