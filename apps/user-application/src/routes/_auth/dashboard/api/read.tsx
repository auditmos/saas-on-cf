...
function ApiReadPage() {
  ...
  const { data: client, isLoading, error, isFetching, refetch } = useQuery({
        ...
        <CardContent className="space-y-4">
          ...
          {!clientId && (
            <Alert>
              ...
              <AlertDescription>Enter a UUID from the List page to fetch client details</AlertDescription>
            </Alert>
          )}
